    ...
    public static void main(String[] args) {
        ...
        while(filaArriba <= 8 || columnaIzquierda >= 1 || filaAbajo >= 8 || columnaDerecha <= 8) {
            ...
            if(filaArriba <= 8 && columnaIzquierda >= 1) {
                ...
                if(mov1.contains(letras.get(columnaIzquierda) + String.valueOf(filaArriba))==false) {
            ...
            if(filaArriba <= 8 && columnaDerecha <= 8) {
                ...
                if(mov1.contains(letras.get(columnaDerecha) + String.valueOf(filaArriba))==false) {
            ...
            if(filaAbajo >= 1 && columnaIzquierda >= 1) {
                ...
                if(mov1.contains(letras.get(columnaIzquierda) + String.valueOf(filaAbajo))==false) {
            ...
            if(filaAbajo >= 1 && columnaDerecha <= 8) {
                ...
                if(mov1.contains(letras.get(columnaDerecha) + String.valueOf(filaAbajo))==false) {
